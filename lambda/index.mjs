...
export const handler = async (event) => {
  try {
    ...
    let prompt = '';
    if (style === 'Trop Rock') {
      prompt = `Write a Trop Rock song with a relaxed vibe around ${bpm} BPM in the key of ${key}. Use the following vivid words creatively: ${labelsString}. The song should have 3 verses and 2 choruses.`;
    } else if (style === 'Southern Blues') {
      prompt = `Write a Southern Blues song with a soulful tone around ${bpm} BPM in the key of ${key}. Use the following vivid words creatively: ${labelsString}. The song should have 3 verses and 2 choruses.`;
    } else if (style === 'Honky Tonk Hits') {
      prompt = `Write an upbeat Honky Tonk song around ${bpm} BPM in the key of ${key}. Use the following descriptive words: ${labelsString}. The song should have 3 verses and 2 choruses.`;
    }
